...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Rule rule : blockList.list) {
            if (rule instanceof BlockAndValidity) {
                ...
                if (!chain.getChainHead().getHeader().getHash().equals(bitcoindChainHead)) {
                    differingBlocks++;
                    log.error("bitcoind and digibytej acceptance differs on block \"" + block.ruleName + "\"");
                }
        ...
        log.info("Done testing.\n" +
                "Blocks which were not handled the same between bitcoind/digibytej: " + differingBlocks + "\n" +
